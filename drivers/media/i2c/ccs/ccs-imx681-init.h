 ...
 * linux-surface-kernel. The Surface Pro 11 values were recovered from
 * Windows I2C traces. Multi-byte registers remain byte-split to preserve
 * the proven write order.
 */
...
static const struct ccs_reg_8 imx681_mode_3844x2640_regs[] = {
	...
	{ 0x034e, 0x0a },
	{ 0x034f, 0x50 },
	/* VT PLL multiplier 225; PLL2 pre-divider 3, multiplier 303. */
	{ 0x0307, 0xe1 },
	{ 0x030d, 0x03 },
	{ 0x030e, 0x01 },
	{ 0x030f, 0x2f },
